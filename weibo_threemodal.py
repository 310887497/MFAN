...
class NeuralNetwork(nn.Module):
    ...
    def mfan(self, x_tid, x_text, y, loss, i, total, params, pgd_word):
        ...
        loss_mse = nn.MSELoss()
        loss_dis = loss_mse(dist[0], dist[1]) + loss_mse(dist[0], dist[2])
    ...
    def fit(self, X_train_tid, X_train, y_train,
        ...
        self.optimizer = torch.optim.Adam(self.parameters(), lr=2e-3, weight_decay=0)  # 修改了weight_decay
...
class CLIP:
    def __init__(self):
        ...
        # model_dict = torch.load(os.getcwd() + "/clip_rumor_3.pth")
...
class MFAN(NeuralNetwork):
    ...
    def forward(self, X_tid, X_text):
        ...
        self_att_t = text_feature_align.view((bsz, -1, 300))
